        ...
        <div className="movie-card__wrap">
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              <h2 className="movie-card__title">{mainMovie.movieTitle}</h2>
              <p className="movie-card__meta">
                <span className="movie-card__genre">
                  {mainMovie.movieGenre}
                </span>
                <span className="movie-card__year">{mainMovie.movieYear}</span>
              </p>
          ...
          <div className="catalog__movies-list">
            {movies.map((movie) => (
              <SmallMovieCard
                ...
                movieSmallCover={movie.movieSmallCover}
              />
            ))}
          </div>
